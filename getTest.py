...
arr = os.listdir('./results_new_huy_36/mul_2v1')
# print(arr)
list_file = []
for dir in arr:
    # list_file.append(dir)
    print(dir)
    list_file.append("./results_new_huy_36/mul_2v1/" + dir)
    # sub = os.listdir("./results/mixed/" + dir)
    cmd = ["python", "evaluateSeparation.py", "--results_dir","./results_new_huy_36/mul_2v1/" + dir]
    subprocess.run(cmd)
