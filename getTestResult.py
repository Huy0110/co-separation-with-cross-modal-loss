...
with open('test_solo_mul_2v1_250_yolo.txt') as f:
#with open('test_solo_solo_250.txt') as f:
    lines = f.readlines()
    for line in lines:
        line = line.split(" ")
        ...
        cmd = ["python", "test.py", "--video1_name", video_name1,"--video2_name", video_name2,"--visual_pool", "conv1x1","--unet_num_layers", "7","--data_path", "/ext_data2/manhnh/MUSIC_dataset","--weights_visual", "/home/manhnguyen/new/co-separation_copy_huy_copy/checkpoint_new_huy_36/audioVisual/visual_best.pth","--weights_unet", "/home/manhnguyen/new/co-separation_copy_huy_copy/checkpoints_new_huy/checkpoint_new_huy/audioVisual/unet_best.pth","--weights_classifier", "/home/manhnguyen/new/co-separation_copy_huy_copy/checkpoints_new_huy/checkpoint_new_huy/audioVisual/classifier_best.pth","--weights_vocal", "/home/manhnguyen/new/co-separation_copy_huy_copy/checkpoints_new_huy/checkpoint_new_huy/audioVisual/vocal_latest.pth", "--weights_facial", "/home/manhnguyen/new/co-separation_copy_huy_copy/checkpoints_new_huy/checkpoint_new_huy/audioVisual/visual_best.pth","--num_of_object_detections_to_use", "5","--scene_path", "/home/manhnguyen/new/co-separation/iccv2019_co_separation/iccv2019_co_separation/ADE.h5","--output_dir_root", "results_new_huy/mul_2v1"]
        subprocess.run(cmd)
...
# arr = os.listdir('./resultsD3/solo_mul_4v1')
# # print(arr)
# list_file = []
# for dir in arr:
#     # list_file.append(dir)
#     print(dir)
#     list_file.append("./resultsD3/solo_mul_4v1/" + dir)
#     # sub = os.listdir("./results/mixed/" + dir)
#     cmd = ["python", "evaluateSeparation.py", "--results_dir","./resultsD3/solo_mul_4v1/" + dir]
#     subprocess.run(cmd)
