...
class TestOptions(BaseOptions):
	def initialize(self):
		...
		self.parser.add_argument('--weights_vocal', type=str, default='', help="weights for audio vocal")
		...
		self.parser.add_argument('--identity_feature_dim', type=int, default=512, help="dimension of identity feature map")
